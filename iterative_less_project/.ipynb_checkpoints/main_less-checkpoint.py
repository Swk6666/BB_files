...
import logging
# --- [终极死锁修复] ---
# 关键：将所有可能初始化CUDA的import，从顶层移入main()函数
# 顶层只保留绝对安全的import和这个用于设置规则的import
import torch.multiprocessing as mp
# --- [修复结束] ---

def main():
    # --- [终极死锁修复] ---
    # 将所有依赖torch, pandas等库的import移到这里
    import json
    import torch
    import pandas as pd
    import random
    ...
    from iterative_less.toolkit import (
        ...
        run_evaluation, verify_optimizer_health, run_matching_subprocess
    )
    ...
    try:
        ...
        # ... (Rest of the main_less.py code is the same) ...
